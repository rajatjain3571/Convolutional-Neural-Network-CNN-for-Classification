...
if mode == 1:
  ...
  file = open("output.txt", append_write)
  file.write("Mode 1" + 'accuracy is %f' % (accuracy) + '\n')
  file.close()
...
if mode == 2:
  ...
  file = open("output.txt", append_write)
  file.write("Mode 2" + 'accuracy is %f' % (accuracy) + '\n')
  file.close()
...
if mode == 3:
  ...
  file = open("output.txt", append_write)
  file.write("Mode 3" + 'accuracy is %f' % (accuracy) + '\n')
  file.close()
...
if mode == 4:
  ...
  file = open("output.txt", append_write)
  file.write("Mode 4" + 'accuracy is %f' % (accuracy) + '\n')
  file.close()
...
if mode == 5:
  ...
  file = open("output.txt", append_write)
  file.write("Mode 5" + 'accuracy is %f' % (accuracy) + '\n')
  file.close()
